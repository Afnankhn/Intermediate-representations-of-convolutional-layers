# -*- coding: utf-8 -*-
"""
Created on Wed Mar 15 05:06:32 2023
...
plt.savefig("human_horse.png", dpi=600) 
plt.show()
...
import cv2
  ...
  # predicting images
folder_path = 'horse-or-human/predict'
...
for layer_name, feature_map in zip(layer_names, successive_feature_maps):
  if len(feature_map.shape) == 4:
    ...
    plt.savefig("intermed_layer_"+str(layer_name)+".png", dpi=600) 
